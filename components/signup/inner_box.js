...
const InnerBox = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row w-[90%] lg:w-[70%] h-[85vh] lg:mb-10 bg-white dark:bg-neutral-500 shadow-shadow justify-center items-center rounded-3xl'>
