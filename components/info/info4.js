...
const Info4 = () => {
  ...
  return (
    <>
      ...
      <div className='flex lg:flex-row flex-col my-5 px-5 items-center justify-center w-full lg:w-[70%] lg:h-[79.9vh] drop-shadow'>
        {/*좌측*/}
        <ul className='flex flex-row lg:flex-col px-5 w-full lg:w-[50vh] lg:m-0 h-full items-center justify-around bg-white dark:bg-gray-400 lg:rounded-l-lg lg:rounded-r-none rounded-lg text-lg font-bold change select-none'>
          {list.map((v, idx) => {
            return (
              <li
        ...
        {/* 우측 */}
        <div className='relative w-full h-[80vh] lg:mt-0 mt-5 p-10 overflow-auto text-xl font-bold bg-gray-300 lg:rounded-l-none lg:rounded-r-lg rounded-lg lg:h-full dark:bg-gray-700 change'>
          {menu ? (
            <div className='flex lg:w-[20vw] p-2 lg:p-5 items-center justify-center rounded-lg drop-shadow lg:text-3xl bg-white dark:bg-gray-500 mb-10 select-none'>{menu}</div>
          ) : (
