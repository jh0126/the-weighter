...
// props.gender 구조분해할당
const TrainingRecommend = ({ gender, status: { age, height, weight } }) => {
    ...
    <>
      <div className='flex flex-col items-center justify-center w-full'>
        ...
        <div className='flex items-center'>
          <label htmlFor='age' className='block px-4 py-2 mb-2 font-bold text-gray-700 bg-blue-400 rounded-lg '>
            나이
          </label>
          <input
            type='text'
        ...
        <div className='flex items-center'>
          <label htmlFor='height' className='block px-4 py-2 mb-2 font-bold text-gray-700 bg-blue-400 rounded-lg '>
            키(cm)
          </label>
          <input
            type='text'
        ...
        <div className='flex items-center'>
          <label htmlFor='weight' className='block px-4 py-2 mb-2 font-bold text-gray-700 bg-blue-400 rounded-lg '>
            체중(kg)
          </label>
          <input
            type='text'
        ...
        <button className='px-4 py-2 font-bold text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none focus:shadow-outline' onClick={onClickSubmitButton}>
          입력
        </button>
      </div>
