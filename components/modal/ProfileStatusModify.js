...
const ProfileStatusModify = ({ open, onClose, age, height, weight, disease, allergy }) => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="flex-full justify-center items-center flex-col mt-8">
          <label>나이</label>
        <div className='flex mb-3'>
          <input className="flex w-full h-8 border-gray-400 border-[1px] rounded-lg px-2" 
            type="number" 
        ...
        <div className='flex mb-3'>
          ...
          <label>질병</label>
          <label className='flex w-full text-gray-500 text-sm mt-1'>콤마로 구분지어주세요. (예: 당뇨병, 고혈압)</label>
        <div className='flex mb-3'>
        <textarea
          ...
          <label>알러지</label>
          <label className='flex w-full text-gray-500 text-sm mt-1'>콤마로 구분지어주세요. (예: 견과, 갑각류)</label>
        <div className='flex mb-3'>
        <textarea
          className="flex w-full h-20 border-gray-400 border-[1px] rounded-lg px-2"
          type="text" 
